...
public class LoginPageHelperLesson15 extends BaseHelperLesson15 {
    ...
    public LoginPageHelperLesson15(WebDriver wd) {
        super(wd);
    }

    public void fillAndSubmitLoginForm(UserLesson15 currentUser) {
        // enter email
    ...
    public void registerUser(UserLesson15 user) {
