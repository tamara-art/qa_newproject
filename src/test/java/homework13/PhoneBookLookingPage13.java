...
//
//public class PhoneBookLookingPage13 extends TestBase13 {
...
//    public static final String VALID_USER_PWD_STR = "ZYxcv_2!";
...
//    public static final String VALID_USER_EMAIL_STR = "nre79368@nezid.com";
...
//
//    @Test
//    public void testAddFormPositive() throws InterruptedException {
//        addUser(VALID_USER_EMAIL_STR, VALID_USER_PWD_STR);
//        // check that the user is added
//        final String xpathExpression = "//*[@id=\"root\"]/div[1]/a[4]";
//        assertElementIsPresent(By.xpath(xpathExpression), "Add new User");
//
//        // The second way to make the same assertions is:
//        // Assert.assertTrue(isWebElementPresent(By.cssSelector("button")) == true, "Log Out button is present");
//        // The third way to make the same assertions is:
...
//    }
//
//    public void addUser(String userEmailStr, String pwdStr) {
